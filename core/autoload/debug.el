...
;;;###autoload
(defun njord/what-face (&optional pos)
...
;;;###autoload
(defun njord-active-minor-modes ()
...
;;;###autoload
(defun njord/what-minor-mode (mode)
  "Get information on an active minor mode. Use `describe-minor-mode' for a
selection of all minor-modes, active or not."
  (interactive
   (list (completing-read "Minor mode: "
                          (njord-active-minor-modes))))
...
(defvar njord--profiler nil)
;;;###autoload
(defun njord/toggle-profiler ()
  (interactive)
  (if (not njord--profiler)
      (profiler-start 'cpu+mem)
    (profiler-report)
    (profiler-stop))
  (setq njord--profiler (not njord--profiler)))
