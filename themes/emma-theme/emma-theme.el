...
(autothemer-deftheme emma "This is Emma's theme"
		     ((((class color) (min-colors 32000)) ((class color) (min-colors 90)) t)
		      (em-dark0_hard     "#1d2021") ;234
		      (em-dark0          "#282828") ;235
		      (em-dark0_soft     "#32302f") ;236
		      (em-dark1          "#3c3836") ;237
		      (em-dark2          "#504945") ;239
		      (em-dark3          "#665c54") ;241
		      (em-dark4          "#7c6f64") ;243
		      (em-dark4_256      "#7c6f64") ;243

		      (em-gray_245       "#928374") ;245
		      (em-gray_244       "#928374") ;244

		      (em-light0_hard    "#f9f5d7") ;230
		      (em-light0         "#fbf1c7") ;229
		      (em-light0_soft    "#f2e5bc") ;228
		      (em-light1         "#ebdbb2") ;223
		      (em-light2         "#d5c4a1") ;250
		      (em-light3         "#bdae93") ;248
		      (em-light4         "#a89984") ;246
		      (em-light4_256     "#a89984") ;246

		      (em-bright_red     "#fb4934") ;167
		      (em-bright_green   "#b8bb26") ;142
		      (em-bright_yellow  "#fabd2f") ;214
		      (em-bright_blue    "#83a598") ;109
		      (em-bright_purple  "#d3869b") ;175
		      (em-bright_aqua    "#8ec07c") ;108
		      (em-bright_orange  "#fe8019") ;208

		      (em-neutral_red    "#cc241d") ;124
		      (em-neutral_green  "#98971a") ;106
		      (em-neutral_yellow "#d79921") ;172
		      (em-neutral_blue   "#458588") ;66
		      (em-neutral_purple "#b16286") ;132
		      (em-neutral_aqua   "#689d6a") ;72
		      (em-neutral_orange "#d65d0e") ;166

		      (em-faded_red      "#9d0006") ;88
		      (em-faded_green    "#79740e") ;100
		      (em-faded_yellow   "#b57614") ;136
		      (em-faded_blue     "#076678") ;24
		      (em-faded_purple   "#8f3f71") ;96
		      (em-faded_aqua     "#427b58") ;66
		      (em-faded_orange   "#af3a03") ;130

		      (em-bg  em-dark0)
		      
		      (em-bg0 em-dark0)
		      ;; TODO: soft dark contrast: dark0_soft
		      ;;       hard dark contrast: dark0_hard
		      (em-bg1 em-dark1)
		      (em-bg2 em-dark2)
		      (em-bg3 em-dark3)
		      (em-bg4 em-dark4)
		      ...
		      (em-fg4_256 em-dark4_256)

		      (em-red em-faded_red)
		      (em-green em-faded_green)
		      (em-yellow em-faded_yellow)
		      (em-blue em-faded_blue)
		      (em-purple em-faded_purple)
		      (em-aqua em-faded_aqua)
		      (em-orange em-faded_orange)

		      (em-delimiter-one "#458588")
		      (em-delimiter-two "#b16286")
		      (em-delimiter-three "#8ec07c")
		      (em-delimiter-four "#d65d0e")
		      (em-black "#000000")
		      (em-white "#ffffff"))
		      ...
		      ((default  (:background em-bg :foreground em-light0))
		       ...
		       (magit-reflog-other (:foreground em-aqua))
		       (magit-reflog-rebase (:foreground em-purple))
